...
| `@honua/sdk-js/source-capabilities` | Bounded claimed/observed/effective capability evaluation with expiring evidence, validated CRS constraints, deterministic fingerprints, and dynamic policy, peer, environment, and authorization gates ([guide](./docs/source-capabilities.md)). |
