...
| `@honua/sdk-js/stac-discovery` | [Bounded static STAC Catalog/Collection/Item traversal](./docs/static-stac-discovery.md) with credential-safe transport, provenance-preserving metadata, and fail-closed COG/GeoParquet/PMTiles/tile/metadata classification. |
