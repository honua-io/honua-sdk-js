...
| `@honua/sdk-js/source-capabilities` | Pure claimed/observed/effective capability evaluation with evidence, deterministic fingerprints, and dynamic policy, peer, environment, and authorization gates ([guide](./docs/source-capabilities.md)). |
