...
| `@honua/sdk-js/source-capabilities` | One-time static evidence/CRS validation plus lightweight claimed/observed/effective evaluation, strict transport verification, deterministic freshness, and dynamic policy, peer, environment, and authorization gates ([guide](./docs/source-capabilities.md)). |
