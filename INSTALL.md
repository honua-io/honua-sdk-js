...
| `@honua/sdk-js/agent-safety` | Side-effect-free runtime validation, effect budgets, signed approval envelopes, context revalidation, and deterministic execution-receipt verification for untrusted plans. |
