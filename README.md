...
The versioned [SDK sample catalog](./docs/generated/sample-catalog.md) tracks all 32 executable examples: 2 qualified golden samples, 11 recipes, 17 labs, and 2 fixtures. Seven journey IDs are reserved; 5 remain explicitly planned candidates. The catalog is the source of truth for track, support, lifecycle, fixture/live evidence, quality profiles, and the honua.io projection.
<!-- sample-catalog:end -->
