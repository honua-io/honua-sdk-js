...
The versioned [SDK sample catalog](./docs/generated/sample-catalog.md) tracks all 34 executable examples: 1 qualified golden sample, 15 recipes, 16 labs, and 2 fixtures. Seven journey IDs are reserved; 6 remain explicitly planned candidates. The catalog is the source of truth for track, support, lifecycle, fixture/live evidence, quality profiles, and the honua.io projection.
<!-- sample-catalog:end -->
