const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./migrated-main-CQMWofd_.js","./preload-helper-KokfPtoz.js","./geometry-input-sr-p8-jRm7C.js"])))=>i.map(i=>d[i]);
...
async function bootstrap() {
	try {
		const [artifacts, generatedTarget] = await Promise.all([loadMigrationWorkbenchArtifacts({ signal: bootstrapController.signal }), __vitePreload(() => import("./migrated-main-CQMWofd_.js"), __vite__mapDeps([0,1,2]), import.meta.url)]);
