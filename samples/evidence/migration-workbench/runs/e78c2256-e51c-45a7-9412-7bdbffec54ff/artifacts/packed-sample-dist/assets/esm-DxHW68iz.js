...
function requestHeader(useBinaryFormat, timeoutMs, userProvidedHeaders, setUserAgent) {
	...
	const userAgent = (_b = (_a = result.get("User-Agent")) !== null && _a !== void 0 ? _a : result.get("X-User-Agent")) !== null && _b !== void 0 ? _b : "connect-es/2.2.0";
