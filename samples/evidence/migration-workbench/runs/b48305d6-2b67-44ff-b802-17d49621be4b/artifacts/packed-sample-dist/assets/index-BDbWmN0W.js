const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/migrated-main-CioyDrap.js","assets/preload-helper-hQ-dqvUN.js","assets/errors-BH9On3v6.js"])))=>i.map(i=>d[i]);
...
async function bootstrap() {
	try {
		const [artifacts, generatedTarget] = await Promise.all([loadMigrationWorkbenchArtifacts({ signal: bootstrapController.signal }), __vitePreload(() => import("./migrated-main-CioyDrap.js"), __vite__mapDeps([0,1,2]))]);
