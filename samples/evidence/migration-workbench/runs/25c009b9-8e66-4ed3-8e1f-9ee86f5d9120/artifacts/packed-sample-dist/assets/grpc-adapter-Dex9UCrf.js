import { C as create } from "./file-Desv2rc0.js";
import { C as StatisticType, S as StatisticDefinitionSchema, _ as DistanceUnit, b as SpatialReferenceSchema, d as GeometrySchema, f as MultiPointGeometrySchema, g as SpatialFilterSchema, h as PolylineGeometrySchema, l as CoordinateSchema, m as PolygonGeometrySchema, o as QueryFeaturesRequestSchema, p as PointGeometrySchema, u as CoordinateSequenceSchema, v as FieldType, x as SpatialRelationship, y as GeometryType } from "./feature_service_pb-DfnP1Jaj.js";
import { i as HonuaGrpcError, t as geometryInputSpatialReference } from "./geometry-input-sr-DTFIisxl.js";
//#region .tmp/sample-runner/aa5fce46-34be-433b-af40-228bc9c151f5/packed-sdk/extract/package/dist/src/core/grpc-adapter.js
/**
...
function toProtoQueryRequest(request) {
	...
	if (request.geometry !== void 0) {
		...
		const inputSpatialReference = spatialReference ?? toProtoSpatialReference(request.extraParams?.inSR) ?? toProtoSpatialReference(geometryInputSpatialReference(request.geometry));
		if (inputSpatialReference) filter.spatialReference = inputSpatialReference;
...
function wrapConnectError(error) {
	if (error instanceof Error && "code" in error && typeof error.code === "number") {
		...
		return new HonuaGrpcError(candidate.code, error.message, "rawMessage" in error ? candidate.rawMessage : void 0, {
