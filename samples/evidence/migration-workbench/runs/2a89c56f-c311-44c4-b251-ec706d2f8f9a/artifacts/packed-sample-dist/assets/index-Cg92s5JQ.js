const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./migrated-main-BBsJbEz_.js","./preload-helper-CW7Fztz1.js","./errors-BFd0zFjQ.js"])))=>i.map(i=>d[i]);
...
async function bootstrap() {
	try {
		const [artifacts, generatedTarget] = await Promise.all([loadMigrationWorkbenchArtifacts({ signal: bootstrapController.signal }), __vitePreload(() => import("./migrated-main-BBsJbEz_.js"), __vite__mapDeps([0,1,2]), import.meta.url)]);
