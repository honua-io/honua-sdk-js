import { y as create } from "./file-Cyyt2sFU.js";
import { A as StatisticType, C as QueryFeaturesRequestSchema, D as SpatialRelationship, E as SpatialReferenceSchema, S as PolylineGeometrySchema, T as SpatialFilterSchema, b as PointGeometrySchema, d as FieldType, g as MultiPointGeometrySchema, i as DistanceUnit, k as StatisticDefinitionSchema, m as GeometryType, n as CoordinateSchema, p as GeometrySchema, r as CoordinateSequenceSchema, x as PolygonGeometrySchema } from "./feature_service_pb-BUjvrXYw.js";
import { r as HonuaGrpcError } from "./errors-XvwBNs-8.js";
//#region .tmp/sample-runner/dc1f2da3-a076-4ab8-8fcd-135a105c5878/packed-sdk/extract/package/dist/src/core/grpc-adapter.js
/**
...
function toProtoQueryRequest(request) {
	...
	if (request.objectIds !== void 0) msg.objectIds = typeof request.objectIds === "string" ? request.objectIds.split(",").map((id) => BigInt(id.trim())) : request.objectIds.map((id) => BigInt(id));
	if (request.resultOffset !== void 0) msg.resultOffset = request.resultOffset;
	if (request.resultRecordCount !== void 0) msg.resultRecordCount = request.resultRecordCount;
