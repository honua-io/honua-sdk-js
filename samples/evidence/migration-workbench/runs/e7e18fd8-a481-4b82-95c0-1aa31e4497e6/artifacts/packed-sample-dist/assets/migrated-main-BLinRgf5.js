const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./esm-YsLoa0G8.js","./esm-C_eIEYjf.js","./file-Desv2rc0.js","./esm-DxHW68iz.js","./feature_service_pb-qnd1TZ-4.js","./feature_service_pb-Pbn2IdA0.js","./grpc-adapter-Cxpv9Y4w.js","./geometry-input-sr-D8GGdR7y.js"])))=>i.map(i=>d[i]);
import { t as __vitePreload } from "./preload-helper-KokfPtoz.js";
import { a as HonuaHttpError, c as HonuaWfsExceptionError, l as HonuaSdkError, n as HonuaAbortError, o as HonuaNetworkError, r as HonuaCapabilityNotSupportedError, s as HonuaTimeoutError, t as geometryInputSpatialReference } from "./geometry-input-sr-D8GGdR7y.js";
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/path-utils.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/compatibility.js
/**
...
function parseCompatibilityEnvelope(payload) {
	if (!isObject$2(payload)) throw new TypeError("Server capabilities response must be a JSON object.");
	if (payload.success === false) {
		const message = typeof payload.message === "string" ? payload.message : "Server capabilities request failed.";
		throw new Error(message);
	}
	if (!isObject$2(payload.data)) throw new TypeError("Server capabilities response is missing a data object.");
	return parseCompatibilityContract(payload.data.compatibility);
}
function parseCompatibilityContract(payload) {
	if (!isObject$2(payload)) throw new TypeError("Server capabilities response is missing data.compatibility.");
	return {
...
function parseControlPlaneApi(payload) {
	if (!isObject$2(payload)) throw new TypeError("Server capabilities response is missing data.compatibility.controlPlaneApi.");
	return {
...
function parseMetadataSchemas(payload) {
	...
	return payload.map((entry, index) => {
		if (!isObject$2(entry)) throw new TypeError(`Server capabilities response metadataSchemas[${index}] must be an object.`);
		return {
...
function parseCompatibilityFeatures(payload) {
	if (!isObject$2(payload)) throw new TypeError("Server capabilities response is missing data.compatibility.features.");
	return {
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/geoservices.js
/**
...
function queryMethod(method, path, params, baseUrl) {
	...
	return url.pathname.length + url.search.length > 2e3 ? "POST" : "GET";
}
/**
...
async function queryFeaturesRest(transport, request, preferBinary) {
	...
	params.set("f", preferBinary && (request.method === void 0 || request.method === "GET") ? "pbf" : "json");
	...
	if (request.method === void 0 && method === "POST" && params.get("f") === "pbf") params.set("f", "json");
	...
	}, request.signal, request.method === void 0 ? { readOnlyQuery: true } : void 0);
}
async function queryMapLayer(transport, request) {
	...
	if (queryMethod(request.method, path, params, transport.baseUrl) === "GET") return transport.requestJson("GET", `${path}?${params.toString()}`, void 0, request.signal);
	return transport.requestJson("POST", path, {
		headers: { "Content-Type": "application/x-www-form-urlencoded" },
		body: params.toString()
	}, request.signal, request.method === void 0 ? { readOnlyQuery: true } : void 0);
...
function serializeQueryParams$1(params, request) {
	...
	if (request.distance !== void 0) params.set("distance", String(request.distance));
	if (request.units !== void 0) params.set("units", request.units);
	if (request.nearestCount !== void 0) params.set("nearestCount", String(request.nearestCount));
	if (request.returnDistance !== void 0) params.set("returnDistance", String(request.returnDistance));
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/odata-key-path.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/odata.js
/**
...
* @module
*/
var MAX_ODATA_METADATA_CHARACTERS = 4194304;
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/ogc-endpoint-layout.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wire-shared.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/ogc-features.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/ogc-maps.js
/**
...
var OGC_MAP_FORMAT_TO_SHORT = /* @__PURE__ */ new Map([
	["image/png", "png"],
	["image/jpeg", "jpeg"],
	["image/jpg", "jpg"],
	["image/tiff", "tiff"],
...
var OGC_MAP_SHORT_TO_MEDIA = /* @__PURE__ */ new Map([
	["png", "image/png"],
	["jpeg", "image/jpeg"],
	["jpg", "image/jpeg"],
	["tiff", "image/tiff"],
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/contract/jobs.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/job-run-errors.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/job-run-lifecycle.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/ogc-processes.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/ogc-records.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/pbf-decoder.js
/**
...
function decodeFeature(reader, fields, transform, geometryType) {
	...
	for (const [position, entry] of valueEntries.entries()) {
		...
		if (fieldIndex < fields.length) attributes[fields[fieldIndex].name] = entry.value;
	}
...
function mapPbfFieldTypeToGeoServices(fieldType) {
	switch (fieldType) {
		...
		case 14: return "esriFieldTypeDateOnly";
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/process-runner.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/request-pipeline.js
...
var DEFAULT_RETRY_METHODS = /* @__PURE__ */ new Set([
	"GET",
	"HEAD",
	"PUT",
	"DELETE"
...
*/
function shouldRetryRequest(retryOptions, method, attempt, statusCode, error, readOnlyQuery = false) {
	if (!retryOptions || attempt >= retryOptions.maxRetries) return false;
	if (!DEFAULT_RETRY_METHODS.has(method) && !readOnlyQuery) return false;
...
*/
var DEFAULT_RETRYABLE_GRPC_CODES = /* @__PURE__ */ new Set([
	4,
	8,
	10,
	14
...
*/
function toHttpError(statusCode, body, responseHeaders) {
	const options = responseHeaders ? { responseHeaders } : void 0;
	const fallback = "Request failed";
	if (isObject$1(body)) {
		const error = body.error;
		if (isObject$1(error) && typeof error.message === "string") return new HonuaHttpError(statusCode, error.message, body, options);
		if (typeof body.message === "string") return new HonuaHttpError(statusCode, body.message, body, options);
		if (typeof body.detail === "string") return new HonuaHttpError(statusCode, body.detail, body, options);
	}
...
function toGeoServicesError(transportStatus, body, responseHeaders) {
	if (!isObject$1(body) || !isObject$1(body.error)) return void 0;
	const error = body.error;
	const protocolCode = typeof error.code === "number" ? error.code : void 0;
	const message = typeof error.message === "string" ? error.message : "Request failed";
	if (protocolCode === void 0 && typeof error.message !== "string") return void 0;
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/stac.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/contract/spatial-aggregation.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/surfaces.js
...
var HonuaFeatureLayer = class {
	...
	async queryFeatureCount(request = {}) {
		...
		if (isObject(response) && typeof response.count === "number" && Number.isFinite(response.count)) return response.count;
		if (isObject(response) && Array.isArray(response.features)) return response.features.length;
		return 0;
	}
	async queryObjectIds(request = {}) {
		...
		if (isObject(response) && Array.isArray(response.objectIds)) return response.objectIds.map((value) => Number(value)).filter((value) => Number.isFinite(value));
		return [];
	}
...
function featureServerH3CellFromFeature(feature, request, plan) {
	...
	if (geometryMode === "boundary" && isObject(feature.geometry)) return {
		...cell,
...
function extentFromGeometry(geometry) {
	...
	if (isFiniteNumber(geometry.xmin) && isFiniteNumber(geometry.ymin) && isFiniteNumber(geometry.xmax) && isFiniteNumber(geometry.ymax)) return {
		...
		xmax: geometry.xmax,
		ymax: geometry.ymax,
		spatialReference: isObject(geometry.spatialReference) ? geometry.spatialReference : void 0
	};
	const coordinates = [];
...
function extractObjectIdsFromResponse(response) {
	if (!isObject(response) || !Array.isArray(response.objectIds)) return [];
...
function extractExtentFromResponse(response) {
	if (!isObject(response)) return { extent: null };
	const count = isFiniteNumber(response.count) ? response.count : void 0;
	return {
		extent: isObject(response.extent) ? response.extent : null,
		count
	};
}
...
*/
var OGC_NEXT_LINK_RESERVED_PARAMS = /* @__PURE__ */ new Set(["f", "limit"]);
/**
...
*/
var OGC_OFFSET_PARAM_NAMES = /* @__PURE__ */ new Set(["offset", "startindex"]);
/**
...
*/
var OGC_CURSOR_PARAM_NAMES = /* @__PURE__ */ new Set([
	"token",
	"nexttoken",
	"pagetoken",
	"continuationtoken",
...
function extractLayerIds(metadata) {
	if (!isObject(metadata) || !Array.isArray(metadata.layers)) return [];
	const ids = [];
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wfs-capabilities.js
/**
...
var WFS_XML_LIMITS = Object.freeze({
	...
	maxAttributeBytesPerElement: 65536,
	maxTextBytes: 524288
});
/**
...
*/
var GML_GEOMETRY_PROPERTY_TYPES = /* @__PURE__ */ new Set([
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wfs-protocol-error.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wfs.js
/**
...
var WFS_METADATA_MAX_RESPONSE_BYTES = 2097152;
var WFS_FEATURE_MAX_RESPONSE_BYTES = 33554432;
/** Output formats (lower-cased) the canonical adapter treats as JSON. */
var JSON_OUTPUT_FORMATS = /* @__PURE__ */ new Set([
	"application/json",
...
var GML_OUTPUT_FORMATS = /* @__PURE__ */ new Set([
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wms-axis.js
/**
...
*/
var WMS_LATLON_GEOGRAPHIC_EPSG = /* @__PURE__ */ new Set([
	4326,
	4258,
	4269,
	4267,
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/xml-text.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/capabilities-xml.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wms-capabilities.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wms.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wms-types.js
/**
...
*/
var WMTS_TILE_FORMAT_TO_EXTENSION = /* @__PURE__ */ new Map([
	["image/png", "png"],
	["image/jpeg", "jpeg"],
	["image/jpg", "jpeg"],
	["image/webp", "webp"]
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wmts-capabilities.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/wmts.js
/**
...
var WMTS_FEATURE_INFO_FORMAT_TO_EXTENSION = /* @__PURE__ */ new Map([
...
var WMTS_REST_RESERVED_KEYS = /* @__PURE__ */ new Set([
	"service",
	"version",
	"request",
	"layer",
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/core/client.js
...
var HonuaClient = class HonuaClient {
	...
	*/
	constructor(options) {
		...
		this.protocolTransport = {
			...
			requestJson: (method, path, init, signal, policy) => this.requestJson(method, path, init, signal, policy),
	...
	async ensureConnectClient() {
		...
		if (!initPromise) {
			initPromise = Promise.all([
				__vitePreload(() => import("./esm-YsLoa0G8.js"), __vite__mapDeps([0,1,2]), import.meta.url),
				__vitePreload(() => import("./esm-DxHW68iz.js"), __vite__mapDeps([3,2,1]), import.meta.url),
				__vitePreload(() => import("./feature_service_pb-qnd1TZ-4.js"), __vite__mapDeps([4,5,2]), import.meta.url)
	...
	*/
	async fetchWithSafeRedirects(url, init, redirectPolicy = "safe-follow") {
		...
		for (let redirects = 0;; redirects += 1) {
			...
			const downgradeToGet = response.status === 303 || (response.status === 301 || response.status === 302) && method !== "GET" && method !== "HEAD";
			if (redirectPolicy === "preserve-method" && downgradeToGet && method !== "GET" && method !== "HEAD") return response;
	...
	static async loadGrpcAdapter() {
		return __vitePreload(() => import("./grpc-adapter-Cxpv9Y4w.js"), __vite__mapDeps([6,2,5,7]), import.meta.url);
	}
	get isGrpcWeb() {
	...
	*/
	...
	async requestJson(method, path, init, callerSignal, policy) {
		const request = {
			url: resolveRequestUrl(this.baseUrl, path),
			path,
			method,
		...
		return this.executeRequest(request, {
			...
			redirect: policy?.readOnlyQuery ? "preserve-method" : void 0,
			finalize: async (response, durationMs, currentRequest, runAfter) => {
	...
	*/
	async executeRequest(initialRequest, options) {
		...
		const readOnlyQuery = options.readOnlyQuery === true && request.method === "POST" && request.method === initialRequest.method && request.url === initialRequest.url && typeof request.init.body === "string";
		...
		for (let attempt = 0;; attempt += 1) {
			...
			try {
				...
				if (shouldRetryRequest(this.retryOptions, request.method, attempt, void 0, normalizedError, readOnlyQuery)) {
			...
			try {
				...
				if (!response.ok && !options.okStatuses?.includes(response.status)) {
					...
					if (!refreshedAuth && (response.status === 401 || response.status === 403) && this.authProvider && (DEFAULT_RETRY_METHODS.has(request.method) || readOnlyQuery)) await options.beforeReplay?.(cloneRequestContext(request), response.status, "authentication");
					const authRefreshedRequest = refreshedAuth ? void 0 : await this.refreshReplaySafeRequestAuth(request, response.status, readOnlyQuery);
					if (authRefreshedRequest) {
						request = authRefreshedRequest;
						refreshedAuth = true;
						continue;
					}
					if (shouldRetryRequest(this.retryOptions, request.method, attempt, response.status, httpError, readOnlyQuery)) {
	...
	*/
	...
	async refreshReplaySafeRequestAuth(request, statusCode, readOnlyQuery = false) {
		if (statusCode !== 401 && statusCode !== 403 || !this.authProvider || !DEFAULT_RETRY_METHODS.has(request.method) && !readOnlyQuery) return;
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/event-bus.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/url.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/feature-layer.js
var DEFAULT_MAX_ATTACHMENT_BYTES = 26214400;
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/feature-table.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/map.js
var MapCompat = class {
	basemap;
	ground;
	tables;
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/widget-host.js
/**
...
var HonuaWidgetHost = class {
	...
	*/
	async mount() {
		if (!this.#container || !globalDom.document) return void 0;
		this.destroy();
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/layer-list.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/feature-filter.js
/**
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/map-view.js
...
//#endregion
//#region .tmp/sample-runner/4b3fdd69-acb1-4777-9067-b887598518cf/packed-sdk/extract/package/dist/src/esri-compat/popup.js
