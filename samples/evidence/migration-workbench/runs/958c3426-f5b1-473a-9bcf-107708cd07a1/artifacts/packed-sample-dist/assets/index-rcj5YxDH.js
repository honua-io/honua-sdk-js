const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./migrated-main-DaMIf-9K.js","./preload-helper-CW7Fztz1.js","./errors-DK9ZK117.js"])))=>i.map(i=>d[i]);
...
async function bootstrap() {
	try {
		const [artifacts, generatedTarget] = await Promise.all([loadMigrationWorkbenchArtifacts({ signal: bootstrapController.signal }), __vitePreload(() => import("./migrated-main-DaMIf-9K.js"), __vite__mapDeps([0,1,2]), import.meta.url)]);
