const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/migrated-main-Dtc_UQ_t.js","assets/preload-helper-hQ-dqvUN.js","assets/errors-Biyxi4wH.js"])))=>i.map(i=>d[i]);
...
async function bootstrap() {
	try {
		const [artifacts, generatedTarget] = await Promise.all([loadMigrationWorkbenchArtifacts({ signal: bootstrapController.signal }), __vitePreload(() => import("./migrated-main-Dtc_UQ_t.js"), __vite__mapDeps([0,1,2]))]);
