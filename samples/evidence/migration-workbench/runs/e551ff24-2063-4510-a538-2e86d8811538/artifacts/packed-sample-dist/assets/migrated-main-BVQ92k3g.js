const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/esm-43ltykJI.js","assets/esm-DWXyzSch.js","assets/file-Cyyt2sFU.js","assets/esm-BfJANlUL.js","assets/feature_service_pb-B9vqZl-f.js","assets/feature_service_pb-B9rAIGUB.js","assets/grpc-adapter-DsRov7ao.js","assets/errors-DUKtV_wa.js"])))=>i.map(i=>d[i]);
import { t as __vitePreload } from "./preload-helper-hQ-dqvUN.js";
import { a as HonuaNetworkError, c as HonuaSdkError, i as HonuaHttpError, n as HonuaCapabilityNotSupportedError, o as HonuaTimeoutError, s as HonuaWfsExceptionError, t as HonuaAbortError } from "./errors-DUKtV_wa.js";
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/path-utils.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/compatibility.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/geoservices.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/odata-key-path.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/odata.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/ogc-endpoint-layout.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wire-shared.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/ogc-features.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/ogc-maps.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/contract/jobs.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/ogc-processes.js
/**
...
var HonuaOgcProcesses = class {
	...
	async describe(processId, request = {}) {
		return this.client.getOgcProcess({
			...request,
			processId
		});
	}
...
var HonuaOgcProcessJobRun = class {
	...
	constructor(options) {
		...
		this.pollFn = options.pollFn ?? ((jobId, signal) => options.client.getOgcProcessJob({
			jobId,
			signal
		}));
		const initial = options.initialStatus;
		this.currentStatus = initial?.status ?? "accepted";
	...
	async results(options = {}) {
		if (!this.terminalPromise) this.terminalPromise = this.runUntilTerminal(options).catch((error) => {
	...
	async cancel() {
		...
		try {
			...
			return (await this.handleOgcStatus(cancelled)).status;
		} catch (error) {
			const statusCode = error?.statusCode;
			if (statusCode === 404) return this.currentStatus;
	...
	async runUntilTerminal(options = {}) {
		...
		while (!this.terminalSnapshot) {
			if (signal?.aborted) throw new HonuaJobPollTimeoutError(`Job ${this.id} poll aborted`, "aborted", this.id, this.currentStatus);
			if (options.maxAttempts !== void 0 && attempts >= options.maxAttempts) throw new HonuaJobPollTimeoutError(`Job ${this.id} did not reach a terminal state within ${options.maxAttempts} poll attempt(s)`, "max-attempts", this.id, this.currentStatus);
			let ogcStatus;
			try {
			...
			if (options.deadlineMs !== void 0 && Date.now() - startedAt >= options.deadlineMs) throw new HonuaJobPollTimeoutError(`Job ${this.id} did not reach a terminal state within ${options.deadlineMs}ms`, "deadline", this.id, this.currentStatus);
			const intervalMs = Math.min(maxIntervalMs, baseIntervalMs * 2 ** (attempts - 1));
			if (intervalMs > 0) await delay(intervalMs, signal);
		}
		if (this.terminalSnapshot.status === "successful" && this.terminalSnapshot.result) return this.terminalSnapshot.result;
	...
	*/
	async handleOgcStatus(ogcStatus) {
		...
		if (status === "successful") try {
			const snapshot = {
				status: "successful",
				progress,
				result: { outputs: await this.client.getOgcProcessJobResults({ jobId: this.id }) }
			};
...
function makeJobFailedError(snapshot) {
	const error = snapshot.error;
	return new HonuaJobFailedError(error?.message ?? `Job ended in non-success terminal state: ${snapshot.status}`, snapshot.status, error?.code, error?.details);
}
...
async function getOgcProcess(transport, request) {
	const params = createOgcMetadataParams(request);
	return transport.requestCachedMetadataJson(`ogc-processes:process:${request.processId}:${params.toString()}`, `/ogc/processes/processes/${encodeURIComponent(request.processId)}?${params.toString()}`, request);
}
async function executeOgcProcess(transport, request) {
	const headers = mergeHeaders({
		"Content-Type": "application/json",
		Accept: "application/json"
	}, request.headers, preferHeaderForExecute(request));
...
async function getOgcProcessJob(transport, request) {
	const params = createOgcMetadataParams(request);
	return transport.requestJson("GET", `/ogc/processes/jobs/${encodeURIComponent(request.jobId)}?${params.toString()}`, void 0, request.signal);
}
async function getOgcProcessJobResults(transport, request) {
	const params = createOgcMetadataParams(request);
	return transport.requestJson("GET", `/ogc/processes/jobs/${encodeURIComponent(request.jobId)}/results?${params.toString()}`, void 0, request.signal);
}
async function cancelOgcProcessJob(transport, request) {
	const params = createOgcMetadataParams(request);
	return transport.requestJson("DELETE", `/ogc/processes/jobs/${encodeURIComponent(request.jobId)}?${params.toString()}`, void 0, request.signal);
}
/**
...
*/
function preferHeaderForExecute(request) {
	if (request.mode === "async") return { Prefer: "respond-async" };
}
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/ogc-records.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/pbf-decoder.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/process-runner.js
...
var GeospatialGrpcProcessJobRun = class {
	...
	async cancel() {
		...
		return (await this.handleJob(response)).status;
	}
	async runUntilTerminal(options = {}) {
		const { signal } = options;
		const baseIntervalMs = options.pollIntervalMs ?? 1e3;
		const maxIntervalMs = options.maxPollIntervalMs ?? Math.max(baseIntervalMs, 3e4);
		const startedAt = Date.now();
		let attempts = 0;
		while (!this.terminalSnapshot) {
			...
			let response;
			try {
				response = await this.client.getJob({
					jobId: this.id,
					signal
				});
			} catch (error) {
		...
		if (this.terminalSnapshot.status === "successful" && this.terminalSnapshot.result) return this.terminalSnapshot.result;
		throw new Error(this.terminalSnapshot.error?.message ?? `geospatial-grpc job ended in ${this.terminalSnapshot.status}`);
	}
	async handleJob(response) {
		...
		if (status === "successful") {
			const snapshot = geospatialGrpcResultSnapshot(await this.client.getJobResult({ jobId: this.id }), progress);
			this.terminalSnapshot = snapshot;
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/request-pipeline.js
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/stac.js
/**
...
var HonuaStacSearch = class {
	...
	async searchAll(request = {}) {
		...
		for (let page = 0; page < maxPages; page += 1) {
			const response = await this.client.searchStac(this.withBase({
				...request,
				limit: pageSize,
				offset: cursor.offset,
				next: cursor.next
			...
			if (cursor.offset === void 0 && cursor.next === void 0) break;
		}
		return items;
	}
	async *searchStream(request = {}) {
...
async function searchStac(transport, request = {}) {
	const base = stacBase(request);
	if (request.usePost) return transport.requestJson("POST", `${base}/search`, {
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/contract/spatial-aggregation.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/surfaces.js
...
var HonuaOgcFeatures = class {
	...
	async itemsAll(request) {
		...
		const features = [];
		for (let page = 0; page < maxPages; page += 1) {
			if (totalLimit !== void 0 && features.length >= totalLimit) break;
			const remainingLimit = totalLimit === void 0 ? pageSize : Math.max(0, totalLimit - features.length);
			if (remainingLimit < 1) break;
			const limit = Math.min(pageSize, remainingLimit);
			const pageFeatures = extractOgcFeatures(await this.items({
				...request,
				limit,
...
var HonuaGeoprocessingJobRun = class {
	...
	async cancel() {
		...
		return (await this.handleGeoprocessingJob(cancelled)).status;
	}
	async runUntilTerminal(options = {}) {
		const { signal } = options;
		const baseIntervalMs = options.pollIntervalMs ?? this.pollIntervalMs;
	...
	async handleGeoprocessingJob(job) {
		...
		if (status === "successful") {
			const snapshot = {
				status,
				progress,
				result: { outputs: await this.resolveOutputs(job) }
			};
			this.terminalSnapshot = snapshot;
			this.notify(snapshot);
			return snapshot;
	...
	async resolveOutputs(job) {
		if (this.resultNames.length === 0) return job?.results ?? {};
		const outputs = {};
		for (const resultName of this.resultNames) outputs[resultName] = await this.resultFn(this.id, resultName);
		return outputs;
	}
	notify(snapshot) {
		for (const listener of this.listeners) listener(snapshot);
...
function progressFromGeoprocessingJob(job) {
	...
	const status = geoprocessingStatusToJobStatus(job.jobStatus);
	const percent = status === "successful" ? 100 : status === "accepted" ? 5 : status === "running" ? 50 : void 0;
	if (percent === void 0 && message === void 0) return void 0;
	return {
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wfs-capabilities.js
/**
...
function parseWfsCapabilities(xml) {
	...
	if (featureTypeList) for (const ft of findChildren(featureTypeList, "FeatureType")) {
		...
		const entry = { name: nameNode?.text.trim() ?? "" };
		...
		if (lowerCorner && upperCorner) {
			...
			if (Number.isFinite(xmin) && Number.isFinite(ymin) && Number.isFinite(xmax) && Number.isFinite(ymax)) entry.wgs84BoundingBox = {
				xmin,
				ymin,
				xmax,
				ymax
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wfs.js
/**
...
var HonuaWfs = class {
	...
	*/
	capabilities(options) {
		if (!this.capabilitiesPromise) this.capabilitiesPromise = this.fetchCapabilities(options).catch((err) => {
	...
	*/
	...
	async requestText(method, path, options) {
		try {
			const requestOptions = { accept: options.accept };
	...
	negotiateOutputFormat(snapshot) {
		...
		for (const format of formats) if (JSON_OUTPUT_FORMATS.has(format)) return {
			kind: "json",
			format
		};
		for (const format of formats) if (GML_OUTPUT_FORMATS.has(format)) return {
			kind: "gml",
			format
		};
...
var HonuaWfsFeatureType = class {
	...
	*/
	async getFeature(params) {
		...
		const requestOptions = { accept: params.outputFormat ?? "application/geo+json, application/json;q=0.9, application/xml;q=0.5" };
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wms-axis.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/xml-text.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/capabilities-xml.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wms-capabilities.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wms.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wms-types.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wmts-capabilities.js
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/wmts.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/core/client.js
...
var HonuaClient = class HonuaClient {
	...
	async ensureConnectClient() {
		...
		if (!initPromise) {
			initPromise = Promise.all([
				__vitePreload(() => import("./esm-43ltykJI.js"), __vite__mapDeps([0,1,2])),
				__vitePreload(() => import("./esm-BfJANlUL.js"), __vite__mapDeps([3,2,1])),
				__vitePreload(() => import("./feature_service_pb-B9vqZl-f.js"), __vite__mapDeps([4,5,2]))
	...
	*/
	...
	static async loadGrpcAdapter() {
		return __vitePreload(() => import("./grpc-adapter-DsRov7ao.js"), __vite__mapDeps([6,7,5,2]));
	}
	get isGrpcWeb() {
	...
	*/
	async pipelineFetch(method, path, init, callerSignal, options = {}) {
		...
		return this.executeRequest(request, {
			...
			...options.discardErrorBody ? { errorBody: (response) => {
	...
	*/
	...
	async applyAfterInterceptors(request, response, durationMs) {
		for (const interceptor of this.interceptors) {
...
async function readBoundedResponseBytes(response, maximum) {
	const advertised = response.headers.get("content-length");
	if (advertised !== null) {
		const length = Number(advertised);
		if (Number.isFinite(length) && length > maximum) {
			await response.body?.cancel().catch(() => void 0);
			throw new HonuaNetworkError(`Metadata response exceeds the configured ${maximum}-byte limit.`, void 0);
		}
	}
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/event-bus.js
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/url.js
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/feature-layer.js
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/feature-table.js
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/map.js
var MapCompat = class {
	basemap;
	ground;
	tables;
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/widget-host.js
/**
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/layer-list.js
var LayerListCompat = class {
	...
	*/
	...
	constructor(options = {}) {
		...
		this.watchListeners = /* @__PURE__ */ new Map();
		this.subscriptions = [];
		const widgetHost = options.container != null ? new HonuaWidgetHost("honua-layer-list", options.container) : void 0;
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/feature-filter.js
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/map-view.js
...
//#endregion
//#region .tmp/sample-runner/83d49070-02bc-4e3b-808f-0ec48ba42a37/packed-sdk/extract/package/dist/src/esri-compat/popup.js
