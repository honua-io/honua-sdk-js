...
the complete evidence command once while the candidate is still planned and
assigned to `golden-browser`, then promote the catalog and point its live lane
at that executed envelope. Generate the projections with
