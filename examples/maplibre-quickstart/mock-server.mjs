...
export const FIXTURE_BUILD_ENV = {
  ...
  VITE_HONUA_QUICKSTART_RESULT_RECORD_COUNT: String(FIRST_MAP_FIXTURE_METADATA.featureCount),
  VITE_HONUA_QUICKSTART_SELECTED_RECORD_ID: FIRST_MAP_FIXTURE_METADATA.selectedRecordId,
