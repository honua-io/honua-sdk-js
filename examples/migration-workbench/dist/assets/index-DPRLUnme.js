const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./migrated-main-29m-aIRA.js","./preload-helper-CW7Fztz1.js","./errors-DqXt0wi8.js"])))=>i.map(i=>d[i]);
...
async function bootstrap() {
	try {
		const [artifacts, generatedTarget] = await Promise.all([loadMigrationWorkbenchArtifacts({ signal: bootstrapController.signal }), __vitePreload(() => import("./migrated-main-29m-aIRA.js"), __vite__mapDeps([0,1,2]), import.meta.url)]);
...
function render(model) {
	...
	getElement("#migration-diff").textContent = model.diff;
}
