...
def render(pages: list[tuple[str, str, str]]) -> str:
    ...
    for section, matches in SECTION_ORDER:
        ...
        # Front doors lead their section; a reader arriving cold should not have
        # to scan an alphabetical list to find the entry point, and the
        # quickstart must precede its own troubleshooting page.
        lead = {'index.md': 0, 'README.md': 1,
                'features/README.md': 0, 'quickstart.md': 0}
