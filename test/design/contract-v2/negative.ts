...
void datasetTilesWithCollection;
void collectionTilesWithoutCollection;
void datasetMapWithCollection;
void collectionMapWithoutCollection;
void serviceShapedMaplibreVector;
void emptyMaplibreTemplates;
void globPmtiles;
void globGeojson;
void runtimeRejectedNetworkLocators;
void measuredBoundingBox;
void unresolvedExecutableBoundingBox;
void runtimeRejectedDistances;
void noCrsAsDefinition;
void runtimeRejectedCrsDefinitions;
void nativeOperatorCapabilityConstraint;
void knownTemporalExtentWithoutIntervals;
void unknownSpatialExtentWithoutProvenance;
void nonTemporalExtentWithoutProvenance;
void rawNextLinkPageRequest;
void forgedContinuation;
void onePartCompositeIdentity;
void scalarIdentityWithoutField;
void scalarIdentityWithWrongField;
void unsupportedCompletePageClaim;
void legacyBareTotalCount;
void exactCountWithoutEvidence;
void runtimeRejectedCounts;
void cursorResultWithOffsetNext;
void runtimeRejectedPageRequests;
void wrongCompositeKeyOrder;
void runtimeRejectedCompositeIdentities;
void runtimeRejectedDuplicateResultIdentities;
void runtimeRejectedFingerprints;
void runtimeRejectedDuplicateKey;
void fieldWithoutDomainKnowledge;
void emptyKnownConstraintState;
void runtimeRejectedDomains;
void runtimeRejectedConstraintCollisions;
void rejectedDuplicatePromotedGeometry;
