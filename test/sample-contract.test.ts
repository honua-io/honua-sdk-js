...
const validationTime = { now: "2026-07-18T00:00:00.000Z" };
...
describe("sample publication contract", () => {
  ...
  it("generates one shared docs/site taxonomy and an executable CI selection", async () => {
    ...
    expect(
      projection.goldenJourneys.find((journey: { id: string }) => journey.id === "service-explorer"),
    ).toMatchObject({ status: "qualified", candidateSampleId: "service-explorer" });
