...
No row, byte, latency, or memory result in this matrix is a live-server claim. The WKB interop artifact is bound to reviewed Honua Server producer commit `66a9d34496c6f6a03dd571957062f773bfef7f0a`, merged as `4ef53ce7f49b78aad3572db1dfc3be88a6654a43`, and proves serialization compatibility only. Its governed receipt records 4160 bytes with SHA-256 `da4ccf9aa159e6e34b448c87712e074438a64f7eb57f38c39bad24a821170f52`. A live status requires a pinned demo-manifest target and the same semantic verification used by the samples gallery.
