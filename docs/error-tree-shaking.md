...
| --- | ---: | ---: | ---: | ---: | --- |
| `/routing` | 7109 B | 4073 B | 42.71% | 5331 B | `dist/src/core/error-base.js` |
| `/geocoding` | 8488 B | 5509 B | 35.10% | 6366 B | `dist/src/core/error-base.js` |
| `/auth` | 8139 B | 5114 B | 37.17% | 6104 B | `dist/src/core/error-base.js` |
| `/realtime` | 12598 B | 9217 B | 26.84% | 9448 B | `dist/src/core/error-base.js` |
| `/offline` | 12301 B | 8450 B | 31.31% | 9225 B | `dist/src/core/error-base.js` |
| `tree-shake:map-source-workflow` | 11161 B | 8325 B | 25.41% | 8370 B | `dist/src/core/error-base.js` |

## Explicit import fixtures

| Fixture | Min | Gzip | Retained error modules |
| --- | ---: | ---: | --- |
| `tree-shake:error-leaf` | 4270 B | 1629 B | `dist/src/core/error-base.js` |
| `tree-shake:error-registry` | 10746 B | 2372 B | `dist/src/core/error-code-registry.js` |
| `tree-shake:error-serializer` | 11771 B | 3469 B | `dist/src/core/error-base.js`<br>`dist/src/core/error-classifications.js`<br>`dist/src/core/error-envelope.js` |
