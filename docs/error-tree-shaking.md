...
| `tree-shake:error-registry` | 10297 B | 2302 B | `dist/src/core/error-code-registry.js` |
| `tree-shake:error-serializer` | 11496 B | 3428 B | `dist/src/core/error-base.js`<br>`dist/src/core/error-classifications.js`<br>`dist/src/core/error-envelope.js` |
