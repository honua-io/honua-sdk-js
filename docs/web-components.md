...
357 cells across 21 components x 17 gates: **153 passing**, 129 failing, 52 pending, 23 not applicable.
...
| `honua-legend` (controls) | survival | pending | pass | n/a | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | n/a | pending | pass | pass |
