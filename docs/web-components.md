...
357 cells across 21 components x 17 gates: **180 passing**, 109 failing, 42 pending, 26 not applicable.
...
| `honua-basemap-control` (web-components) | survival | pass | pass | pass | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-bookmarks` (web-components) | survival | pass | pass | pass | pass | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-locate-control` (web-components) | survival | pass | pass | pass | pass | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-measure-control` (web-components) | survival | pass | pass | pass | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
...
| `honua-sketch-control` (web-components) | survival | pass | pass | pass | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
