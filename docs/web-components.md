...
357 cells across 21 components x 17 gates: **133 passing**, 129 failing, 74 pending, 21 not applicable.
...
| `honua-swipe-control` (controls) | survival | pass | pass | pending | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pending | pending | pending | pass | pass |
