...
357 cells across 21 components x 17 gates: **205 passing**, 84 failing, 42 pending, 26 not applicable.
...
| `honua-legend` (controls) | survival | n/a | pass | n/a | n/a | pass | FAIL | FAIL | FAIL | pass | pending | FAIL | pass | pass | n/a | pending | pass | pass |
...
| `honua-feature-table` (web-components) | survival | pass | pass | pass | n/a | pass | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
...
| `honua-editor` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
...
| `honua-basemap-control` (web-components) | survival | pass | pass | pass | n/a | pass | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-bookmarks` (web-components) | survival | pass | pass | pass | pass | pass | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-locate-control` (web-components) | survival | pass | pass | pass | pass | pass | pass | pass | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-measure-control` (web-components) | survival | pass | pass | pass | n/a | pass | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
...
| `honua-sketch-control` (web-components) | survival | pass | pass | pass | n/a | pass | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-print-export` (web-components) | survival | pass | pass | pass | n/a | pass | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
...
| `honua-action-panel` (web-components) | survival | pass | pass | pass | n/a | pass | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
