...
357 cells across 21 components x 17 gates: **163 passing**, 124 failing, 44 pending, 26 not applicable.
...
| `honua-swipe-control` (controls) | survival | pass | pass | pass | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
