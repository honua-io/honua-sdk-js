...
357 cells across 21 components x 17 gates: **136 passing**, 129 failing, 71 pending, 21 not applicable.
...
| `honua-measurement` (web-components) | survival | pass | pass | pending | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pending | pending | pass | pass |
