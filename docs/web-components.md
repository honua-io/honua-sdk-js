...
357 cells across 21 components x 17 gates: **153 passing**, 129 failing, 49 pending, 26 not applicable.
...
| `honua-bookmarks` (web-components) | survival | pass | pass | pass | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-locate-control` (web-components) | survival | pass | pass | pass | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
