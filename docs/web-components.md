...
357 cells across 21 components x 17 gates: **188 passing**, 101 failing, 42 pending, 26 not applicable.
...
| `honua-chart` (web-components) | survival | n/a | pass | n/a | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | n/a | pending | pass | pass |
