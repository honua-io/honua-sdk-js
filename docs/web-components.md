...
357 cells across 21 components x 17 gates: **162 passing**, 125 failing, 44 pending, 26 not applicable.
...
| `honua-feature-editor` (web-components) | production | pass | pass | pass | n/a | FAIL | FAIL | FAIL | FAIL | pending | pending | FAIL | pass | pass | pass | pending | pass | pass |
