...
357 cells across 21 components x 17 gates: **143 passing**, 129 failing, 62 pending, 23 not applicable.
...
| `honua-layer-list` (controls) | survival | pending | pass | pass | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pending | pending | pass | pass |
