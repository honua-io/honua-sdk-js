...
357 cells across 21 components x 17 gates: **190 passing**, 99 failing, 42 pending, 26 not applicable.
...
| `honua-map` (web-components) | survival | pass | pass | pass | pass | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
