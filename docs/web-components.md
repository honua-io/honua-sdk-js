...
357 cells across 21 components x 17 gates: **289 passing**, 0 failing, 42 pending, 26 not applicable.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `honua-basemap-switcher` (controls) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-swipe-control` (controls) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-legend` (controls) | survival | n/a | pass | n/a | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | n/a | pending | pass | pass |
| `honua-layer-list` (controls) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-map` (web-components) | survival | pass | pass | pass | pass | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-layer-list` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-legend` (web-components) | survival | n/a | pass | n/a | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | n/a | pending | pass | pass |
| `honua-feature-table` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-search` (web-components) | survival | pass | pass | pass | pass | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-editor` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-feature-editor` (web-components) | production | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-chart` (web-components) | survival | n/a | pass | n/a | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | n/a | pending | pass | pass |
| `honua-basemap-control` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-bookmarks` (web-components) | survival | pass | pass | pass | pass | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-locate-control` (web-components) | survival | pass | pass | pass | pass | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-measure-control` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-measurement` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-sketch-control` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-print-export` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-map-status` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
| `honua-action-panel` (web-components) | survival | pass | pass | pass | n/a | pass | pass | pass | pass | pass | pending | pass | pass | pass | pass | pending | pass | pass |
