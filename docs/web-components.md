...
357 cells across 21 components x 17 gates: **193 passing**, 96 failing, 42 pending, 26 not applicable.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `honua-basemap-switcher` (controls) | survival | pass | pass | pass | n/a | pass | pass | pass | FAIL | pass | pending | FAIL | pass | pass | pass | pending | pass | pass |
...
| `honua-map-status` (web-components) | survival | pass | pass | pass | n/a | pass | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
