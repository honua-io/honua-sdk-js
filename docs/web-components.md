...
357 cells across 21 components x 17 gates: **175 passing**, 114 failing, 42 pending, 26 not applicable.
...
| `honua-search` (web-components) | survival | pass | pass | pass | pass | FAIL | pass | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
