...
357 cells across 21 components x 17 gates: **146 passing**, 129 failing, 59 pending, 23 not applicable.
...
| `honua-map` (web-components) | survival | pending | pass | pass | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
