...
357 cells across 21 components x 17 gates: **164 passing**, 123 failing, 44 pending, 26 not applicable.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `honua-basemap-switcher` (controls) | survival | pass | pass | pass | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-swipe-control` (controls) | survival | pass | pass | pass | n/a | pass | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
| `honua-legend` (controls) | survival | n/a | pass | n/a | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | n/a | pending | pass | pass |
| `honua-layer-list` (controls) | survival | pass | pass | pass | n/a | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
...
| `honua-search` (web-components) | survival | pass | pass | pass | pass | FAIL | FAIL | FAIL | FAIL | FAIL | pending | FAIL | pass | pass | pass | pending | pass | pass |
...
| `honua-feature-editor` (web-components) | production | pass | pass | pass | n/a | pass | FAIL | FAIL | FAIL | pending | pending | FAIL | pass | pass | pass | pending | pass | pass |
