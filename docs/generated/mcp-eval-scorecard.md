...
**Observation window:** 2026-07-05 → 2026-08-18
(4 distinct observation dates,
...
### Certification failures and skips — 2026-08-18

From [`mcp/evals/runs/2026-08-18/cert-standalone.json`](https://github.com/honua-io/honua-sdk-js/blob/trunk/mcp/evals/runs/2026-08-18/cert-standalone.json). Failures are real conformance defects in the
...
They are enumerated in [`mcp/evals/runs/2026-08-18/cert-standalone.json`](https://github.com/honua-io/honua-sdk-js/blob/trunk/mcp/evals/runs/2026-08-18/cert-standalone.json) under `knownGaps`.
