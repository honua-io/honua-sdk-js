...
| --- | --- | --- | --- | --- | --- |
| [`ai-spatial-app-builder`](../../examples/ai-spatial-app-builder/README.md) | flagship | experimental | hybrid | keep | Proves proposal, policy validation, explicit approval, bounded execution, refusal, and tamper-evident receipt states. |
