...
| <a id="imagery-cog-quickstart"></a>[`imagery-cog-quickstart`](../../examples/imagery-cog-quickstart/README.md) | recipe | imagery-terrain | supported | rework | browser-recipe | hybrid | approved | Searches STAC, inspects bounded COG range transport, compares published imagery, and samples terrain elevation profiles. |
