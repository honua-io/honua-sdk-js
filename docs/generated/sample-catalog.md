...
| <a id="geocoding-quickstart"></a>[`geocoding-quickstart`](../../examples/geocoding-quickstart/README.md) | recipe | - | supported | active | browser-recipe | hybrid | approved | Runs forward, reverse, and suggestion workflows with map feedback. |
| <a id="geoprocessing-job-runner"></a>[`geoprocessing-job-runner`](../../examples/geoprocessing-job-runner/README.md) | recipe | - | supported | merge | browser-recipe | hybrid | approved | Submits, polls, cancels, and inspects asynchronous geoprocessing jobs. |
| <a id="imagery-cog-quickstart"></a>[`imagery-cog-quickstart`](../../examples/imagery-cog-quickstart/README.md) | recipe | imagery-terrain | supported | merge | browser-recipe | hybrid | approved | Compares WMS imagery, COG-backed ImageServer tiles, and export previews. |
| <a id="kepler-analytics"></a>[`kepler-analytics`](../../examples/kepler-analytics/README.md) | lab | - | experimental | rework | browser-lab | hybrid | approved | Replays operations data through kepler.gl with linked filters and KPI evidence. |
| <a id="maplibre-quickstart"></a>[`maplibre-quickstart`](../../examples/maplibre-quickstart/README.md) | golden | first-map | supported | active | golden-browser | hybrid | approved | Connects, discovers, explains, queries, and mounts one source with linked views and inspectable evidence. |
...
| <a id="migration-workbench"></a>[`migration-workbench`](../../docs/migration-honua-maplibre.md) | lab | arcgis-migration | supported | rework | browser-lab | fixture | not-required | Scans and transforms ArcGIS application source with auditable compatibility results. |
...
| <a id="service-explorer"></a>[`service-explorer`](../../examples/service-explorer/README.md) | lab | service-explorer | supported | rework | browser-lab | hybrid | approved | Browses heterogeneous spatial services with capability and cache diagnostics. |
...
| <a id="storytelling-25d-map"></a>[`storytelling-25d-map`](../../examples/storytelling-25d-map/README.md) | lab | - | supported | merge | browser-lab | hybrid | approved | Combines terrain, extrusion, OGC overlays, and route playback in a guided story. |
...
| <a id="terrain-rgb-elevation"></a>[`terrain-rgb-elevation`](../../examples/terrain-rgb-elevation/README.md) | recipe | - | supported | merge | browser-recipe | hybrid | approved | Reads Terrain-RGB tiles for point elevation and route profiles. |
