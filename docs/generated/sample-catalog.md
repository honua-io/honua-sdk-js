...
| <a id="columnar-query-quickstart"></a>[`columnar-query-quickstart`](../../examples/columnar-query-quickstart/README.md) | recipe | - | experimental | active | browser-recipe | fixture | not-required | Builds an inspectable Arrow query plan with server pushdown and hard browser resource ceilings before any bytes move. |
