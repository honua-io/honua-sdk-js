...
| <a id="maplibre-quickstart"></a>[`maplibre-quickstart`](../../examples/maplibre-quickstart/README.md) | recipe | first-map | supported | active | golden-browser | hybrid | approved | Discovers GeoServices or OGC Features, explains a bounded query, and mounts an inspectable MapLibre map. |
