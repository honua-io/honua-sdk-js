...
| <a id="imagery-cog-quickstart"></a>[`imagery-cog-quickstart`](../../examples/imagery-cog-quickstart/README.md) | recipe | imagery-terrain | supported | rework | browser-recipe | hybrid | legacy-unsafe | Discovers a STAC COG, discloses bounded reads, and renders it in MapLibre with published raster paths for comparison. |
