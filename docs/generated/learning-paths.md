...
- Sample contract: `flagship` · `supported`
- Data and auth: `hybrid` · `anonymous`
- Provenance: Deterministic incident stream or deployed demo stream.
- Freshness: Snapshot time, cursor, lag, and observation window.
- Catalog degradation: Disconnected or replayed state is visually distinct and mutation controls remain disabled.
