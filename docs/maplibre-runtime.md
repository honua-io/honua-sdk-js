...
> behalf, so a vulnerable map is a vulnerable application. The optional peer range is
> `^6.4.1`, so affected 5.x and 6.0.0 through 6.4.0 releases do not satisfy it.
