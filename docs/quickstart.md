...
Required CI starts a monotonic clock before Node setup, runs `npm ci`, provisions Chromium, builds this fixture app,
and stops only after all five stages complete with renderable features and a mounted MapLibre canvas. The 300-second
ceiling is enforced by:
