...
_Generated 2026-07-11 at commit `04969f0`._
...
| `/map` | 79.6 KiB | 87.4 KiB | 21.8 KiB | 24.0 KiB |
| `/geoparquet` (duckdb-wasm external — lazy peer) | 16.3 KiB | 17.8 KiB | 5.9 KiB | 6.5 KiB |
...
| tree-shake guard (`{ mountSourceToMapLibre }` from `/map`) | 17.2 KiB | 18.8 KiB | 6.4 KiB | 7.0 KiB |
