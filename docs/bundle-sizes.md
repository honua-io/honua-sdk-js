...
_Generated 2026-08-31 at commit `2ae8bbd0b`._
...
| `/studio-agent` (SSE + MCP transports and the turn loop; bundles its agent-tools dependency) | 39.0 KiB | 42.1 KiB | 12.4 KiB | 13.3 KiB |
