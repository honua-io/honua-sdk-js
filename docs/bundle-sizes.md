...
_Generated 2026-07-13 at commit `99c99df`._
...
| `/runtime` | 429.2 KiB | 458.7 KiB | 112.6 KiB | 119.5 KiB |
...
| `/esri-compat` | 948.0 KiB | 1026.2 KiB | 234.7 KiB | 253.6 KiB |
...
| tree-shake guard (`{ bindTerraDrawSketch }` from `/runtime`, terra-draw external) | 3.0 KiB | 3.3 KiB | 1.4 KiB | 1.5 KiB |
