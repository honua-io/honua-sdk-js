...
_Generated 2026-07-25 at commit `04677646`._
...
| `/geoparquet` (duckdb-wasm external — lazy peer) | 125.4 KiB | 137.8 KiB | 37.2 KiB | 40.9 KiB |
...
| `/analytics` (contract + accessible default presentation; no chart adapter, no chart peer) | 32.0 KiB | 35.2 KiB | 10.5 KiB | 11.6 KiB |
...
| tree-shake guard (`/analytics` contract + default presentation, chart adapters/peers excluded) | 23.9 KiB | 26.3 KiB | 8.3 KiB | 9.2 KiB |
