...
_Generated 2026-08-25 at commit `f62fbcff`._
...
| `/studio-agent` (SSE + MCP transports and the turn loop; bundles its agent-tools dependency) | 31.3 KiB | 34.4 KiB | 10.0 KiB | 11.0 KiB |
