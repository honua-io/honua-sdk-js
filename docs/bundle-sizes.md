...
_Generated 2026-09-13 at commit `c72b81cf8`._
...
| `/studio-agent` (SSE + MCP transports and the turn loop; bundles its agent-tools dependency) | 42.9 KiB | 46.9 KiB | 13.7 KiB | 15.0 KiB |
