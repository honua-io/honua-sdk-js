...
| `/runtime` | 605.8 KiB | 612.2 KiB | 164.1 KiB | 180.5 KiB |
| `/realtime` | 78.7 KiB | 86.2 KiB | 22.8 KiB | 25.0 KiB |
| `/offline` | 150.6 KiB | 165.7 KiB | 41.1 KiB | 45.2 KiB |
| `/query-planner` (worker runtime injected) | 740.5 KiB | 778.7 KiB | 166.3 KiB | 182.9 KiB |
...
| `/geoparquet` (duckdb-wasm external — lazy peer) | 140.0 KiB | 154.9 KiB | 42.3 KiB | 46.6 KiB |
...
| `/controls` (framework-free control kit; includes the lazy web-components registration chunk) | 1011.8 KiB | 1037.6 KiB | 272.1 KiB | 277.9 KiB |
| `/web-components` (custom-element kit; maplibre-gl external, export adapters injected) | 1088.4 KiB | 1120.1 KiB | 295.5 KiB | 321.9 KiB |
...
| `/react` (react/react-dom external) | 541.8 KiB | 562.6 KiB | 146.0 KiB | 150.2 KiB |
