...
_Generated 2026-07-14 at commit `d792539`._

| Entrypoint | Min | Min budget | Gzip | Gzip budget |
| --- | ---: | ---: | ---: | ---: |
| `.` (root) | 398.3 KiB | 425.3 KiB | 104.7 KiB | 112.5 KiB |
| `/honua` | 512.0 KiB | 566.2 KiB | 135.2 KiB | 149.6 KiB |
| `/contract` | 258.5 KiB | 287.3 KiB | 68.0 KiB | 72.9 KiB |
...
| `/runtime` | 450.5 KiB | 458.7 KiB | 118.9 KiB | 131.7 KiB |
| `/realtime` | 45.0 KiB | 49.3 KiB | 12.4 KiB | 13.5 KiB |
| `/offline` | 40.5 KiB | 44.3 KiB | 12.1 KiB | 13.2 KiB |
| `/query-planner` (worker runtime injected) | 90.5 KiB | 98.5 KiB | 26.4 KiB | 28.6 KiB |
| `/scene-workspace` (MapLibre/Cesium external — optional peers) | 92.5 KiB | 100.0 KiB | 28.5 KiB | 30.8 KiB |
| `/esri-compat` | 980.4 KiB | 1026.2 KiB | 243.8 KiB | 253.6 KiB |
...
| `/map` | 167.1 KiB | 182.2 KiB | 46.5 KiB | 50.7 KiB |
| `/geoparquet` (duckdb-wasm external — lazy peer) | 41.9 KiB | 46.5 KiB | 13.1 KiB | 14.6 KiB |
| `/deckgl` (deck.gl external — lazy peer) | 15.0 KiB | 16.5 KiB | 5.0 KiB | 5.6 KiB |
| `/react` (react/react-dom external) | 432.0 KiB | 446.7 KiB | 113.8 KiB | 117.2 KiB |
| `/geometry` (turf/proj4 bundled — real consumer cost) | 516.4 KiB | 568.0 KiB | 142.7 KiB | 157.0 KiB |
| browser IIFE (`./browser` unpkg/jsdelivr) | 399.0 KiB | 426.0 KiB | 104.9 KiB | 112.8 KiB |
| browser ESM (`./browser`) | 397.7 KiB | 424.6 KiB | 104.6 KiB | 112.5 KiB |
| tree-shake guard (`{ HonuaClient }` only) | 212.9 KiB | 229.7 KiB | 53.9 KiB | 57.6 KiB |
| tree-shake guard (`{ connect }` from root, source-schema runtime excluded) | 345.3 KiB | 359.2 KiB | 88.9 KiB | 92.8 KiB |
| tree-shake guard (`{ FeatureLayerCompat }` from `/esri-compat`) | 227.6 KiB | 245.9 KiB | 57.3 KiB | 61.4 KiB |
| tree-shake guard (`{ buffer }` from `/geometry`, turf bundled) | 287.5 KiB | 316.3 KiB | 65.6 KiB | 72.2 KiB |
| tree-shake guard (`{ mountSourceToMapLibre }` from `/map`) | 35.8 KiB | 37.7 KiB | 11.3 KiB | 12.0 KiB |
