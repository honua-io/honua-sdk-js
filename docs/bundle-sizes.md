...
_Generated 2026-07-21 at commit `8b8413ca`._

| Entrypoint | Min | Min budget | Gzip | Gzip budget |
| --- | ---: | ---: | ---: | ---: |
| `.` (root) | 615.1 KiB | 661.1 KiB | 163.2 KiB | 168.9 KiB |
| `/honua` | 781.8 KiB | 849.0 KiB | 208.6 KiB | 226.0 KiB |
| `/contract` | 289.3 KiB | 317.1 KiB | 76.8 KiB | 83.7 KiB |
| `/source-schema` (focused schema + pinned PROJJSON validator) | 762.5 KiB | 829.5 KiB | 165.2 KiB | 179.5 KiB |
| `/source-capabilities` (static evidence ingestion + lightweight evaluator) | 254.0 KiB | 257.5 KiB | 31.3 KiB | 33.2 KiB |
| `/source-capability-discovery` (GeoServices/OData/WMS/WMTS schema-bound evaluation) | 795.5 KiB | 865.8 KiB | 173.9 KiB | 189.2 KiB |
| `/plugin` (registry + certification, no heavy peers) | 58.5 KiB | 62.6 KiB | 18.1 KiB | 19.3 KiB |
...
| `/runtime` | 533.4 KiB | 550.7 KiB | 143.6 KiB | 147.5 KiB |
| `/realtime` | 61.3 KiB | 67.3 KiB | 17.8 KiB | 19.5 KiB |
| `/offline` | 38.1 KiB | 44.3 KiB | 11.3 KiB | 13.2 KiB |
| `/query-planner` (worker runtime injected) | 582.7 KiB | 638.9 KiB | 118.6 KiB | 129.9 KiB |
| `/scene-workspace` (MapLibre/Cesium external — optional peers) | 94.2 KiB | 100.0 KiB | 29.0 KiB | 30.8 KiB |
| `/esri-compat` | 985.3 KiB | 1026.2 KiB | 245.7 KiB | 253.6 KiB |
...
| `/style` | 61.1 KiB | 69.0 KiB | 15.2 KiB | 17.2 KiB |
| `/map` | 177.0 KiB | 182.2 KiB | 50.0 KiB | 50.7 KiB |
| `/geoparquet` (duckdb-wasm external — lazy peer) | 125.3 KiB | 137.8 KiB | 37.2 KiB | 40.9 KiB |
| `/cog` (caller-injected decoder; no raster peer in the static graph) | 51.7 KiB | 56.1 KiB | 14.8 KiB | 16.1 KiB |
| `/deckgl` (deck.gl external — lazy peer) | 62.5 KiB | 68.3 KiB | 16.7 KiB | 18.3 KiB |
| `/react` (react/react-dom external) | 463.1 KiB | 506.7 KiB | 123.0 KiB | 134.6 KiB |
| `/geometry` (turf/proj4 bundled — real consumer cost) | 516.4 KiB | 568.0 KiB | 142.7 KiB | 157.0 KiB |
| browser IIFE (`./browser` unpkg/jsdelivr) | 615.7 KiB | 661.8 KiB | 163.5 KiB | 176.3 KiB |
| browser ESM (`./browser`) | 614.4 KiB | 660.4 KiB | 163.2 KiB | 176.0 KiB |
| tree-shake guard (`{ HonuaClient }` only) | 217.8 KiB | 229.7 KiB | 55.8 KiB | 57.6 KiB |
| tree-shake guard (`{ connect }` from root, source-schema runtime excluded) | 476.7 KiB | 515.1 KiB | 124.7 KiB | 135.1 KiB |
...
| tree-shake guard (`{ createHonua }` managed discovery + accepted-plan facade) | 582.2 KiB | 627.9 KiB | 154.5 KiB | 167.0 KiB |
| tree-shake guard (`{ FeatureLayerCompat }` from `/esri-compat`) | 232.4 KiB | 245.9 KiB | 59.0 KiB | 61.4 KiB |
