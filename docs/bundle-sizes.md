...
| --- | ---: | ---: | ---: | ---: |
| `.` (root) | 753.9 KiB | 829.3 KiB | 202.3 KiB | 211.8 KiB |
| `/honua` | 916.6 KiB | 937.2 KiB | 246.6 KiB | 251.0 KiB |
| `/contract` | 367.4 KiB | 400.6 KiB | 99.0 KiB | 108.0 KiB |
| `/source-schema` (focused schema + pinned PROJJSON validator) | 889.0 KiB | 925.5 KiB | 200.8 KiB | 206.0 KiB |
| `/source-capabilities` (static evidence ingestion + lightweight evaluator) | 254.8 KiB | 257.5 KiB | 31.4 KiB | 33.2 KiB |
| `/source-capability-discovery` (GeoServices/OData/WMS/WMTS schema-bound evaluation) | 922.9 KiB | 961.8 KiB | 210.0 KiB | 215.6 KiB |
| `/plugin` (registry + certification, no heavy peers) | 66.5 KiB | 69.2 KiB | 20.1 KiB | 21.9 KiB |
| `/agent-tools` | 36.2 KiB | 38.2 KiB | 10.2 KiB | 10.9 KiB |
| `/agent-safety` | 68.0 KiB | 73.2 KiB | 18.9 KiB | 20.5 KiB |
| `/nl-map-control` | 78.0 KiB | 84.5 KiB | 23.0 KiB | 25.3 KiB |
| `/runtime` | 606.6 KiB | 612.2 KiB | 164.0 KiB | 180.4 KiB |
...
| `/pmtiles` (bounded direct inspection + managed lifecycle; renderer runtime excluded) | 632.7 KiB | 696.0 KiB | 170.1 KiB | 187.1 KiB |
...
| `/react` (react/react-dom external) | 542.5 KiB | 562.6 KiB | 145.9 KiB | 150.2 KiB |
| `/geometry` (turf/proj4 bundled — real consumer cost) | 516.4 KiB | 568.0 KiB | 142.7 KiB | 157.0 KiB |
| browser IIFE (`./browser` unpkg/jsdelivr) | 754.5 KiB | 754.5 KiB | 202.7 KiB | 222.1 KiB |
| browser ESM (`./browser`) | 753.2 KiB | 828.5 KiB | 202.3 KiB | 221.7 KiB |
| tree-shake guard (`{ HonuaClient }` only) | 240.2 KiB | 254.0 KiB | 62.0 KiB | 63.6 KiB |
| tree-shake guard (`{ connect }` from root, source-schema runtime excluded) | 614.7 KiB | 627.9 KiB | 163.8 KiB | 166.9 KiB |
...
| tree-shake guard (`{ createHonua }` managed discovery + accepted-plan facade) | 716.8 KiB | 717.1 KiB | 192.7 KiB | 210.6 KiB |
