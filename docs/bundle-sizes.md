...
_Generated 2026-08-04 at commit `5505649a`._

| Entrypoint | Min | Min budget | Gzip | Gzip budget |
| --- | ---: | ---: | ---: | ---: |
| `.` (root) | 716.8 KiB | 753.9 KiB | 192.6 KiB | 211.8 KiB |
| `/honua` | 881.3 KiB | 937.2 KiB | 237.4 KiB | 251.0 KiB |
| `/contract` | 344.9 KiB | 352.8 KiB | 92.9 KiB | 94.1 KiB |
| `/source-schema` (focused schema + pinned PROJJSON validator) | 860.7 KiB | 925.5 KiB | 193.0 KiB | 206.0 KiB |
| `/source-capabilities` (static evidence ingestion + lightweight evaluator) | 254.7 KiB | 257.5 KiB | 31.4 KiB | 33.2 KiB |
| `/source-capability-discovery` (GeoServices/OData/WMS/WMTS schema-bound evaluation) | 894.0 KiB | 961.8 KiB | 202.4 KiB | 215.6 KiB |
...
| `/controls` (framework-free control kit; includes the lazy web-components registration chunk) | 959.6 KiB | 1037.6 KiB | 257.8 KiB | 277.9 KiB |
| `/web-components` (custom-element kit; maplibre-gl external, export adapters injected) | 1036.0 KiB | 1120.1 KiB | 281.2 KiB | 292.6 KiB |
...
| browser IIFE (`./browser` unpkg/jsdelivr) | 717.4 KiB | 754.5 KiB | 192.9 KiB | 201.3 KiB |
| browser ESM (`./browser`) | 716.1 KiB | 753.1 KiB | 192.6 KiB | 201.0 KiB |
| tree-shake guard (`{ HonuaClient }` only) | 231.4 KiB | 254.0 KiB | 59.7 KiB | 63.6 KiB |
| tree-shake guard (`{ connect }` from root, source-schema runtime excluded) | 586.4 KiB | 627.9 KiB | 156.5 KiB | 166.9 KiB |
...
| tree-shake guard (`{ createHonua }` managed discovery + accepted-plan facade) | 683.3 KiB | 717.1 KiB | 183.8 KiB | 191.3 KiB |
