...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-08-04 at commit `ee7786c5`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 740.4 KiB | 198.9 KiB |
| Importing only `HonuaClient` (tree-shake guard) | 231.5 KiB | 59.7 KiB |
...
| ArcGIS compatibility layer (drop-in migration surface) | 1012.1 KiB | 253.4 KiB |
...
- **Minified:** engine 1036.3 KiB + Honua root 740.4 KiB ≈ **1.74 MB**.
- **Gzip:** engine 273.8 KiB + Honua root 198.9 KiB ≈ **0.46 MB**.
