...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-07-19 at commit `5808d71b`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 613.4 KiB | 162.8 KiB |
...
| ArcGIS compatibility layer (drop-in migration surface) | 985.2 KiB | 245.7 KiB |
...
our **uncompressed minified** bytes (engine 1024.9 KiB + Honua root 613.4 KiB ≈
