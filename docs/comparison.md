...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-07-13 at commit `b69c95a`;
...
| Protocol-neutral contract (`Dataset`/`Source`/`Query`/`Result`) | 227.1 KiB | 58.7 KiB |
| ArcGIS compatibility layer (drop-in migration surface) | 946.0 KiB | 234.2 KiB |
| Geocoding client | 12.5 KiB | 3.9 KiB |
| Routing client | 6.0 KiB | 2.4 KiB |
