...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-08-04 at commit `9186a6ba`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 738.7 KiB | 198.4 KiB |
...
- **Minified:** engine 1036.3 KiB + Honua root 738.7 KiB ≈ **1.73 MB**.
