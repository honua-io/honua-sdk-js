...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-08-04 at commit `7b343df2`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 747.5 KiB | 200.8 KiB |
...
| ArcGIS compatibility layer (drop-in migration surface) | 1019.3 KiB | 255.3 KiB |
...
- **Minified:** engine 1036.3 KiB + Honua root 747.5 KiB ≈ **1.74 MB**.
- **Gzip:** engine 273.8 KiB + Honua root 200.8 KiB ≈ **0.46 MB**.
