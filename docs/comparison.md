...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-08-03 at commit `4665ebbf`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 697.2 KiB | 186.3 KiB |
...
our **uncompressed minified** bytes (engine 1036.3 KiB + Honua root 697.2 KiB ≈
