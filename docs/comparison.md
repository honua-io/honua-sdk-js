...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-07-17 at commit `1f2aa85f`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 531.4 KiB | 140.2 KiB |
| Importing only `HonuaClient` (tree-shake guard) | 211.9 KiB | 53.6 KiB |
...
our **uncompressed minified** bytes (engine 1024.9 KiB + Honua root 531.4 KiB ≈
1.52 MB) against Esri's reported startup JavaScript total
