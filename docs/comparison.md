...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-07-16 at commit `05506e2`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 419.8 KiB | 109.7 KiB |
...
| Protocol-neutral contract (`Dataset`/`Source`/`Query`/`Result`) | 256.1 KiB | 67.3 KiB |
...
our **uncompressed minified** bytes (engine 1024.9 KiB + Honua root 419.8 KiB ≈
