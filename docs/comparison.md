...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-07-17 at commit `5e83da11`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 460.3 KiB | 120.9 KiB |
...
our **uncompressed minified** bytes (engine 1024.9 KiB + Honua root 460.3 KiB ≈
1.45 MB) against Esri's reported startup JavaScript total
