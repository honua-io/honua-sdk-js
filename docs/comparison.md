...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-08-03 at commit `34733d2e`;
...
| --- | ---: | ---: |
| Full root entrypoint: connect → query → explain → mount workflow | 738.0 KiB | 198.3 KiB |
...
- **Minified:** engine 1036.3 KiB + Honua root 738.0 KiB ≈ **1.73 MB**.
- **Gzip:** engine 273.8 KiB + Honua root 198.3 KiB ≈ **0.46 MB**.
