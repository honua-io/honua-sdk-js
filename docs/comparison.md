...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-08-03 at commit `a5da1a0d`;
...
- **Minified:** engine 1036.3 KiB + Honua root 697.2 KiB ≈ **1.69 MB**.
- **Gzip:** engine 273.8 KiB + Honua root 186.3 KiB ≈ **0.45 MB**.
