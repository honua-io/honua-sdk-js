...
[`docs/bundle-sizes.md`](./bundle-sizes.md) (measured 2026-09-07 at commit `66f91b6e2`;
...
- **Minified:** engine 1036.3 KiB + Honua root 776.4 KiB ≈ **1.77 MB**.
- **Gzip:** engine 273.8 KiB + Honua root 210.3 KiB ≈ **0.47 MB**.
