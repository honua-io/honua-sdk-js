...
patches (which must also invalidate or re-version their cached base batch),
application-specific CSP worker URL policy, and bounded conversion back to
feature objects remain separate work.
