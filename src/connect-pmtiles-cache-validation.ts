/** Pure fail-closed validation for a cached PMTiles v7 discovery snapshot. */
import {
  MAX_CACHE_SNAPSHOT_SINGLE_STRING_CODE_UNITS,
  snapshotCacheData,
  validateCachedEvidence,
} from "./connect-cache-data.js";
import { HONUA_CONNECT_DISCOVERY_SNAPSHOT_VERSION } from "./connect-constants.js";
import {
...
export function validateCachedPmtilesSnapshot(
