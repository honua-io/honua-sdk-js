...
export const HONUA_ERROR_CODE_REGISTRY = Object.freeze({
  ...
  "core.zarr.metadata-pending": classification(
    ...
    "validation",
    false,
    "Zarr registration metadata is pending and not ready for handoff",
  ),
  "core.zarr.missing-spatial-extent": classification(
    "core",
    "validation",
    false,
    "Zarr spatial extent metadata is missing or non-degenerate",
  ),
  "core.zarr.no-tileable-variable": classification(
    "core",
    "validation",
    false,
    "No Zarr variable is eligible for tile handoff",
  ),
  "core.zarr.missing-spatial-reference": classification(
    "core",
    "validation",
    false,
    "Zarr spatial reference is missing or invalid",
  ),
  "core.zarr.spatial-reference-mismatch": classification(
    "core",
    "validation",
    false,
    "Zarr and tile matrix spatial references do not match",
  ),
  "core.zarr.unsupported-version": classification(
    "core",
    "capability",
    false,
    "Zarr version is unsupported by the contract",
  ),
  "core.zarr.unsupported-codec": classification(
    "core",
    "capability",
    false,
  ...
  "core.zarr.ambiguous-dimensions": classification(
    ...
    "validation",
    false,
    "Zarr variable dimensions are ambiguous for tile handoff",
  ),
